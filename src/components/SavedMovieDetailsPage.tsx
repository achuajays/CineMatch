...
const SavedMovieDetailsPage: React.FC = () => {
  ...
  const movie = location.state?.movie as SavedMovie;
        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#2c3135] px-4 md:px-10 py-3">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-9">
              ...
              <button 
                onClick={() => navigate('/saved')}
                className="text-blue-400 text-sm font-medium leading-normal flex items-center gap-2"
              >
                <ArrowLeft size={16} />
                Saved Movies
              </button>
            ...
            <div className="px-4 py-6">
              <div className="bg-[#2c3135] rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-[#a2abb3]">Saved on:</span>
                    <span className="text-white ml-2">{formatDate(movie.savedAt)}</span>
                  </div>
                </div>
              </div>
            </div>
...
export default SavedMovieDetailsPage;